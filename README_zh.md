...
本仓库是个人公开 fork（`trevorWieland/nanoclaw`），并非上游主仓库。建议先阅读英文文档中的 fork 导航：

- [README.md](README.md) 中的 `About This Fork`
- [docs/START_HERE.md](docs/START_HERE.md)
- [docs/FORK_OVERVIEW.md](docs/FORK_OVERVIEW.md)
- [CONTRIBUTING.md](CONTRIBUTING.md)（说明哪些贡献应提交到上游 `qwibitai/nanoclaw`）
...
```bash
git clone https://github.com/trevorWieland/nanoclaw.git
cd nanoclaw
claude
```
