...
describe("add-compact skill package", () => {
  ...
  describe("modify/ files exist", () => {
    const modifyFiles = ["src/index.ts", "container/agent-runner/src/index.ts"];
  ...
  describe("intent files exist", () => {
    const intentFiles = ["src/index.ts.intent.md", "container/agent-runner/src/index.ts.intent.md"];
  ...
  describe("modify/src/index.ts", () => {
    ...
    beforeAll(() => {
      content = fs.readFileSync(path.join(SKILL_DIR, "modify", "src", "index.ts"), "utf-8");
    });
