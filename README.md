...
Read [CONTRIBUTING.md](CONTRIBUTING.md) before opening a PR. For the full architecture details, see the [documentation site](https://docs.nanoclaw.dev/concepts/architecture).
